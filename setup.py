...
setup(
    ...
    packages = [
        ...
        'lcls2_epix_hr_pcie.lcls2_pgp_fw_lib.hardware.XilinxKcu1500',
        'lcls2_epix_hr_pcie.lcls2_pgp_fw_lib.hardware.SlacPgpCardG4',
        'lcls2_epix_hr_pcie.lcls2_pgp_fw_lib.hardware',
        'lcls2_epix_hr_pcie.lcls2_pgp_fw_lib.hardware.shared',
